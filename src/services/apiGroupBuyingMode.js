...
export async function fakeAccountLogin(params) {
  ...
  return request(`/api/v1/user/admin/wx_work/login/wx_work_auth_data?${stringify(params)}`);
}
...
export async function uploadGroupEditDate(params) {
    ...
    return request(`/api/v1/agency/admin/organization/edit/${params.OrganizationId}`,{
      method: 'POST',
      body: params,
    });
}
...
export async function queryPurchaseList(params) {
  return request(`/api/v1/group_buying_order/admin/task/list/${params.OrganizationId}?${stringify(params)}`)
}
...
export async function queryPurchaseMontherList(params) {
  return request(`/api/v1/group_buying_order/admin/task/month_list/${params.OrganizationId}?${stringify(params)}`)
}
...
export async function queryCheckBind(params) {
  return request(`/api/v1/user/admin/user/check_bind_mobile/${params}`);
}
...
export async function queryOrderFormList(params) {
  return request(`/api/v1/group_buying_order/admin/indent/list/${params.OrganizationId}?${stringify(params)}`)
}
...
export async function queryOrderInfo(params) {
  return request(`/api/v1/group_buying_order/admin/indent/summary/${params}`)
}
...
export async function queryDistributionList(params) {
  return request(`/api/v1/group_buying_order/admin/send/list/${params.OrganizationId}?${stringify(params)}`)
}
...
export async function queryDistributionRoute(params) {
  return request(`/api/v1/group_buying_order/admin/line/list/${params.OrganizationId}?${stringify(params)}`)
}
...
export async function queryDistributionRouteCommunity(params) {
  return request(`/api/v1/group_buying_order/admin/line_community/list/${params.OrganizationId}/${params.LineId}?${stringify(params)}`)
}
...
export async function queryGroupCommunityInfo(params) {
  return request(`/api/v1/community/admin/group/info/${params.OrganizationId}/${params.GroupId}`)
}
/**
 * 获取团购组织id
 * @param params
