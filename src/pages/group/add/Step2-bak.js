...
class StepForm extends PureComponent {
  ...
  render(){
  const { formItemLayout, form, data, dispatch,tokens,QINIU_SERVER } = this.props;
  ...
  const onPrev = () => {
    ...
    dispatch(routerRedux.push('/group/groupList&/groupAdd'));
  };
  ...
  const onValidateForm = () => {
    validateFields((err, values) => {
      if (!err) {
        ...
        dispatch(routerRedux.push('/group/groupList&/groupAdd/result'));
      }
    });
  };
